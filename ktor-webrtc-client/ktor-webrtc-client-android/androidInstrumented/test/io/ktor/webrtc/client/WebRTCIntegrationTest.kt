...
class AndroidWebRTCEngineUnitTest {
    ...
    private fun createClient() = WebRTCClient(AndroidWebRTC) {
        iceServers = this@AndroidWebRTCEngineUnitTest.iceServers
        turnServers = this@AndroidWebRTCEngineUnitTest.turnServers
        statsRefreshRate = 100 // 100 ms refresh rate
        mediaTrackFactory = DefaultMediaDevices(ctx)
    }
    ...
    @Test
    fun testCreateVideoTrack() = runTestWithRealTime {
