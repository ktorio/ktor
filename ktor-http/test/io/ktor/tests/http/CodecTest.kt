...
class CodecTest {
    ...
    fun testUTFEncodeDecode() {
        ...
        assertEquals("%D0%92%D1%81%D0%B5%D0%BC%5F%D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82", russian.encodeURLQueryComponent(encodeFull = true))
    ...
    fun testAllReserved() {
        ...
        assertEquals("%2A%7E%21%40%23%24%25%5E%26%28%29%2B%7B%7D%22%5C%3B%3A%60%2C%2F%5B%5D", text.encodeURLQueryComponent(encodeFull = true))
