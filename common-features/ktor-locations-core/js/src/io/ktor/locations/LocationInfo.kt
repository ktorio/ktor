...
public actual class LocationInfo @InternalAPI public actual constructor(
    ...
    @Deprecated("This is only supported on JVM", level = DeprecationLevel.ERROR)
    public val klass: KClass<*> get() = throw UnsupportedOperationException("No longer supported. JVM only.")

    @InternalAPI
    public actual val klassOrNull: KClass<*>? get() = null
