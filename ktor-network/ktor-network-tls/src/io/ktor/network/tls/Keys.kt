...
internal fun ByteArray.clientKey(suite: CipherSuite) = SecretKeySpec(
    this,
...
internal fun ByteArray.serverKey(suite: CipherSuite) = SecretKeySpec(
    this,
...
internal fun ByteArray.clientIV(suite: CipherSuite) = copyOfRange(
...
internal fun ByteArray.serverIV(suite: CipherSuite) = copyOfRange(
    2 * suite.macStrengthInBytes + 2 * suite.keyStrengthInBytes + suite.fixedIvLength,
