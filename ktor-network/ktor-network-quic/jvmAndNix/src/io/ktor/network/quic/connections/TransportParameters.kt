...
internal class TransportParameters(
     ...
     */
    val stateless_reset_token: ByteArray? = null,
     ...
     */
    val max_udp_payload_size: Int = 65527,
     ...
     */
    val initial_max_stream_data_bidi_local: Int = 0,
     ...
     */
    val initial_max_stream_data_bidi_remote: Int = 0,
     ...
     */
    val initial_max_stream_data_uni: Int = 0,
     ...
     */
    val initial_max_streams_bidi: Int = 0,
     ...
     * of the corresponding type with the same value.
     */
    val initial_max_streams_uni: Int = 0,
     ...
     */
    val disable_active_migration: Int = 0,
     ...
     */
    val preferred_address: PreferredAddress? = null,
     ...
     */
    val active_connection_id_limit: Int = 2,
