 ...
 */
public actual val MEMORY_EMPTY: Memory = Memory(DataView(ArrayBuffer(0)))
...
private class MemoryImpl(override val view: DataView) : Memory()

public fun Memory(view: DataView): Memory = MemoryImpl(view)

/**
 * Size of memory range in bytes.
 */
public actual inline val Memory.size: Long get() = view.byteLength.toLong()
 ...
 */
public actual inline val Memory.size32: Int get() = view.byteLength
