...
public actual abstract class Charset(internal val _name: String) {
    ...
    override actual fun hashCode(): Int {
        return _name.hashCode()
    }

    override actual fun toString(): String {
        return _name
    }
}

@Suppress("LocalVariableName")
public actual fun charsetForName(name: String): Charset {
...
public actual fun isCharsetSupported(charset: String): Boolean = when {
