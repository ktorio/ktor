 ...
 * The provided instance shouldn't be captured and used outside the [block] otherwise an undefined behaviour
 ...
 * Depending on the pool it may be safe or unsafe to capture and use the provided buffer outside the [block].
