...
/**
 * Open a channel and launch a coroutine to copy bytes from the source to the channel.
 * Please note that it may block your async code when started on [Dispatchers.Unconfined]
 * since [RawSource] is blocking on it's nature
 *
 * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.utils.io.jvm.javaio.toByteReadChannel)
 */
@Suppress("UNUSED_PARAMETER")
public fun RawSource.toByteReadChannel(context: CoroutineContext): ByteReadChannel =
    RawSourceChannel(this, context)
