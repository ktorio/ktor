...
private const val EXTRA_SOURCE_SETS_PROBLEM_ID = "ktor-extra-source-sets"
private const val EXTRA_SOURCE_SETS_PROBLEM_NAME = "Extra source sets detected"
...
private fun ProblemReporter.reportExtraSourceSetsWarning(context: String) = reporting {
    id(EXTRA_SOURCE_SETS_PROBLEM_ID, EXTRA_SOURCE_SETS_PROBLEM_NAME)
...
private fun ProblemReporter.reportExtraSourceSetsError(context: String) = throwing {
    id(EXTRA_SOURCE_SETS_PROBLEM_ID, EXTRA_SOURCE_SETS_PROBLEM_NAME)
    withException(IllegalStateException(EXTRA_SOURCE_SETS_PROBLEM_NAME))
    contextualLabel(context)
    details(
        """
