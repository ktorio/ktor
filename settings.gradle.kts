...
include(":ktor-client:ktor-client-plugins:ktor-client-json:ktor-client-json-gson")
include(":ktor-client:ktor-client-plugins:ktor-client-json:ktor-client-json-jackson")
include(":ktor-client:ktor-client-plugins:ktor-client-json:ktor-client-json-serialization")
...
include(":ktor-client:ktor-client-plugins:ktor-client-serialization")
include(":ktor-client:ktor-client-plugins:ktor-client-serialization:ktor-client-serialization-tests")
include(":ktor-client:ktor-client-plugins:ktor-client-serialization:ktor-client-serialization-json")
include(":ktor-client:ktor-client-plugins:ktor-client-serialization:ktor-client-serialization-cbor")
