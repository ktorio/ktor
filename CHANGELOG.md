...
### Improvements
* SSE: ClientSSESession doesn't behave like a CoroutineScope ([KTOR-8440](https://youtrack.jetbrains.com/issue/KTOR-8440))
* Update Kotlin to 2.2.20 ([KTOR-8896](https://youtrack.jetbrains.com/issue/KTOR-8896))
* Support serving static resources within bootJar (nested jars) ([KTOR-8592](https://youtrack.jetbrains.com/issue/KTOR-8592))
