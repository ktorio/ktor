...
val cacheMap: Map<String, String> = mapOf(
    ...
    "https://redirector.kotlinlang.org/maven/dev" to "https://cache-redirector.jetbrains.com/maven/dev",
...
abstract class CheckRepositoriesTask : DefaultTask() {
    ...
    private fun logNonCachedRepo(
        ...
        val details = "Using non cached repository may lead to download failures in CI builds." +
            " Check https://github.com/ktorio/ktor/blob/main/gradle-settings-logic/src/main/kotlin/ktorsettings.cache-redirector.settings.gradle.kts for details."
