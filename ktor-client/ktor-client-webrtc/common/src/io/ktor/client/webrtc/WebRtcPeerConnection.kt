...
public sealed interface TrackEvent {
     ...
     * This is not the same as MediaStreamTrack's `ended` event.
     */
...
public abstract class WebRtcPeerConnection(iceCandidatesReplay: Int, remoteTracksReplay: Int) : Closeable {
    protected val statsFlow: MutableStateFlow<List<WebRtc.Stats>> = MutableStateFlow(listOf())
    ...
    protected val iceCandidatesFlow: MutableSharedFlow<WebRtc.IceCandidate> = MutableSharedFlow(iceCandidatesReplay)
    ...
    protected val iceConnectionStateFlow: MutableStateFlow<WebRtc.IceConnectionState> =
    ...
    protected val connectionStateFlow: MutableStateFlow<WebRtc.ConnectionState> =
    ...
    protected val iceGatheringStateFlow: MutableStateFlow<WebRtc.IceGatheringState> =
    ...
    protected val signalingStateFlow: MutableStateFlow<WebRtc.SignalingState> =
    ...
    protected val trackEventsFlow: MutableSharedFlow<TrackEvent> = MutableSharedFlow(remoteTracksReplay)
    ...
    protected lateinit var negotiationNeededCallback: (() -> Unit)

    /**
     * @return platform-specific peer connection used under the hood. Use with caution.
     */
    public abstract fun <T> getNativeConnection(): T
