...
abstract class AbstractClientContentNegotiationTest : TestWithKtor() {
    ...
    private suspend inline fun <reified T : Any> BaseCall.respond(
        responseJson: String,
        contentType: ContentType
    ): Unit = respond(responseJson, contentType, T::class.serializer())

    protected open suspend fun <T : Any> BaseCall.respond(
        responseJson: String,
        contentType: ContentType,
    ...
    protected open suspend fun BaseCall.respondWithRequestBody(contentType: ContentType) {
