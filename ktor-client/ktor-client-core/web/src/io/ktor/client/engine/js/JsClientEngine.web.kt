...
import io.ktor.client.engine.js.mapToKtor
...
private fun getKeys(headers: Headers): JsArray<JsString> =
    js("Array.from(headers.keys())")

@OptIn(InternalAPI::class)
internal fun Headers.mapToKtor(method: HttpMethod, attributes: Attributes): Headers = buildHeaders {
...
public class JsError(public val origin: JsErrorLike?) : Throwable("Error from javascript[$origin].")
