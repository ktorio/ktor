...
@Deprecated(message = "Renamed to ServletServerRequest", replaceWith = ReplaceWith("ServletServerRequest"))
public typealias ServletApplicationRequest = ServletServerRequest

public abstract class ServletServerRequest(
    call: PipelineCall,
    public val servletRequest: HttpServletRequest
) : BaseServerRequest(call) {
    ...
    override val engineHeaders: Headers = ServletRequestHeaders(servletRequest)
