...
@Deprecated(message = "Renamed to JettyServerEngineBase", replaceWith = ReplaceWith("JettyServerEngineBase"))
public typealias JettyApplicationEngineBase = JettyServerEngineBase

/**
 * [ServerEngine] base type for running in a standalone Jetty
 */
public open class JettyServerEngineBase(
    ...
    override fun start(wait: Boolean): JettyServerEngineBase {
