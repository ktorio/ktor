...
@InternalAPI
@Deprecated(message = "Renamed to JettyServerResponse", replaceWith = ReplaceWith("JettyServerResponse"))
public typealias JettyApplicationResponse = JettyServerResponse

public class JettyServerResponse(
