 ...
 */
internal val corsPlugin: RouteScopedPlugin<CORSConfig> = createRouteScopedPlugin("CORS", ::CORSConfig) {
    buildPlugin()
}

@Deprecated(
    message = "Use Application.cors and Route.cors methods instead which also configure OPTIONS routes for preflight requests",
    level = DeprecationLevel.ERROR,
)
public val CORS: RouteScopedPlugin<CORSConfig> = corsPlugin
