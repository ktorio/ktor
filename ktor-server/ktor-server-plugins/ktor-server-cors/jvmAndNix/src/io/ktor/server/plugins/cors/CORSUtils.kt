...
internal fun BaseCall.accessControlAllowOrigin(
    origin: String,
...
internal fun BaseCall.corsVary() {
...
internal fun BaseCall.accessControlAllowCredentials(allowCredentials: Boolean) {
    if (allowCredentials) {
        response.header(HttpHeaders.AccessControlAllowCredentials, "true")
    }
}

internal fun BaseCall.accessControlMaxAge(maxAgeHeaderValue: String?) {
...
internal fun BaseCall.corsCheckCurrentMethod(methods: Set<HttpMethod>): Boolean = request.httpMethod in methods

internal fun BaseCall.corsCheckRequestMethod(methods: Set<HttpMethod>): Boolean {
...
internal suspend fun BaseCall.respondCorsFailed() {
