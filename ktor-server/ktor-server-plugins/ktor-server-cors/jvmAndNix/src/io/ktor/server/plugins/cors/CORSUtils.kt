...
internal fun ServerCall.accessControlAllowOrigin(
    origin: String,
...
internal fun ServerCall.corsVary() {
...
internal fun ServerCall.accessControlAllowCredentials(allowCredentials: Boolean) {
    if (allowCredentials) {
        response.header(HttpHeaders.AccessControlAllowCredentials, "true")
    }
}

internal fun ServerCall.accessControlMaxAge(maxAgeHeaderValue: String?) {
...
internal fun ServerCall.corsCheckCurrentMethod(methods: Set<HttpMethod>): Boolean = request.httpMethod in methods

internal fun ServerCall.corsCheckRequestMethod(methods: Set<HttpMethod>): Boolean {
...
internal suspend fun ServerCall.respondCorsFailed() {
