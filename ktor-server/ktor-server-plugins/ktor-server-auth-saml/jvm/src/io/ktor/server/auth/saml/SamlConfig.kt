...
public class SamlConfig internal constructor(
    ...
    /**
     * Configuration for the replay cache.
     */
    internal var replayCache: SamlReplayCache = InMemorySamlReplayCache()

    /**
     * Authentication function that validates the SAML credential and returns a Principal.
     */
