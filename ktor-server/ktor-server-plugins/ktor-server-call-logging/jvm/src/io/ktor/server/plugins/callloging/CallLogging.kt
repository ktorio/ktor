 ...
 */
public val CallLogging: ApplicationPlugin<Application, CallLoggingConfig, PluginInstance> = createApplicationPlugin(
    "CallLogging",
    ::CallLoggingConfig
) {
...
private fun ApplicationPluginBuilder<CallLoggingConfig>.logCompletedCalls(logSuccess: (ApplicationCall) -> Unit) {
    onCall { call ->
        call.afterFinish {
...
private fun ApplicationPluginBuilder<CallLoggingConfig>.logCallsWithMDC(logSuccess: (ApplicationCall) -> Unit) {
