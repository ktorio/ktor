...
public class JWTAuthenticationProvider internal constructor(config: Config) : AuthenticationProvider(config) {
    ...
    private val authHeader: (BaseCall) -> HttpAuthHeader? = config.authHeader
    ...
    public class Config internal constructor(name: String?) : AuthenticationProvider.Config(name) {
        ...
        internal var authHeader: (BaseCall) -> HttpAuthHeader? =
         ...
         */
        public fun authHeader(block: (BaseCall) -> HttpAuthHeader?) {
            authHeader = block
        }
         ...
         */
        public fun validate(validate: suspend BaseCall.(JWTCredential) -> Principal?) {
