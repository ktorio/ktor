...
internal fun ServerCall.oauth1aHandleCallback(): OAuthCallback.TokenPair? {
...
internal suspend fun ServerCall.redirectAuthenticateOAuth1a(
    settings: OAuthServerSettings.OAuth1aServerSettings,
...
internal suspend fun ServerCall.redirectAuthenticateOAuth1a(authenticateUrl: String, requestToken: String) {
