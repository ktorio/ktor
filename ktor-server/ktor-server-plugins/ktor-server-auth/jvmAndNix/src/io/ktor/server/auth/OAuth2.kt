...
internal suspend fun Call.oauth2HandleCallback(): OAuthCallback.TokenSingle? {
...
internal suspend fun Call.redirectAuthenticateOAuth2(
...
private suspend fun Call.redirectAuthenticateOAuth2(
