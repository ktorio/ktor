...
public class BearerAuthenticationProvider internal constructor(config: Config) : AuthenticationProvider(config) {
    ...
    public class Config(name: String?) : AuthenticationProvider.Config(name) {
        ...
        internal var getAuthHeader: (ServerCall) -> HttpAuthHeader? = { call ->
         ...
         */
        public fun authenticate(authenticate: suspend ServerCall.(BearerTokenCredential) -> Principal?) {
         ...
         */
        public fun authHeader(getAuthHeader: (ServerCall) -> HttpAuthHeader?) {
