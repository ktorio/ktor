...
class ApplicationRequestHeaderTest {
    ...
    @Test
    fun testApplicationHandlesRequestsToFoo() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testApplicationHandlesRequestsToFooWithParameters() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testApplicationHandlesRequestsToRootWithParameters() = testSuspend {
        withTestApplication {
