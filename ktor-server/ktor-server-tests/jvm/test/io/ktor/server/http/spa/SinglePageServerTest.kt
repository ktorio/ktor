...
class SinglePageServerTest {
    @Test
    fun fullWithFilesTest() = testServer {
        application {
            routing {
    ...
    @Test
    fun testIgnoreAllRoutes() = testServer {
        application {
            routing {
                singlePageApplication {
                    filesPath = "jvm/test/io/ktor/server/http/spa"
    ...
    @Test
    fun fullWithResourcesTest() = testServer {
        application {
            routing {
                singlePageApplication {
                    useResources = true
    ...
    @Test
    fun testIgnoreResourceRoutes() = testServer {
        application {
            routing {
                singlePageApplication {
                    useResources = true
    ...
    @Test
    fun testIgnoreAllResourceRoutes() = testServer {
        application {
            routing {
                singlePageApplication {
                    useResources = true
