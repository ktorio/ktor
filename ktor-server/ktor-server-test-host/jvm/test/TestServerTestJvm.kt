...
class TestServerTestJvm {

    @Test
    fun testDefaultConfigDoesNotLoad() = testServer {
        application {
    ...
    @Test
    fun testWebSocketWithError() = testServer {
        application {
    ...
    @Test
    fun testCustomEnvironmentKeepsDefaultProperties() = testServer {
        environment {
    ...
    @Test
    fun testExplicitDefaultConfig() = testServer {
        environment {
    ...
    @Test
    fun testCustomConfig() = testServer {
        environment {
            config = ApplicationConfig("application-custom.conf")
        }
        routing {
    ...
    @Test
    fun testCustomYamlConfig() = testServer {
        environment {
    ...
    @Test
    fun testConfigLoadsModules() = testServer {
        environment {
    ...
    @Test
    fun testExternalServicesCustomConfig() = testServer {
        environment {
            config = ApplicationConfig("application-custom.conf")
        }
        externalServices {
    ...
    @Test
    fun testModuleWithLaunch() = testServer {
    ...
    @Test
    fun testMultipleParallelWebSocketsRequests() = testServer {
        install(WebSockets)
        routing {
            webSocket("/") {
    ...
    @Test
    fun testRetrievingPluginInstance() = testServer {
    ...
    @Test
    fun testWebSocketConnectionFailed() = testServer {
        val client = createClient {
            install(io.ktor.client.plugins.websocket.WebSockets)
        }
    ...
    private fun testSocketTimeoutWrite(timeout: Long, expectException: Boolean) = testServer {
        routing {
            post {
...
class MyCalculatorPlugin {
    class Configuration
    companion object Plugin : BaseServerPlugin<ServerCallPipeline, Configuration, MyCalculatorPlugin> {
