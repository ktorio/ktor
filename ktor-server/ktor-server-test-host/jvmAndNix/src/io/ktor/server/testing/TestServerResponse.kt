...
@Deprecated(message = "Renamed to TestServerResponse", replaceWith = ReplaceWith("TestServerResponse"))
public typealias TestApplicationResponse = TestServerResponse
...
) : BaseServerResponse(call), CoroutineScope by call {
