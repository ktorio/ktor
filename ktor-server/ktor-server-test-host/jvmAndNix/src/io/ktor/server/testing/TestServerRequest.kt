...
@Deprecated(message = "Renamed to TestServerRequest", replaceWith = ReplaceWith("TestServerRequest"))
public typealias TestApplicationRequest = TestServerRequest
...
public class TestServerRequest(
    ...
    override val local: RequestConnectionPoint = object : RequestConnectionPoint {
        ...
        override val port: Int
            get() = this@TestServerRequest.port
        ...
        override val localPort: Int
            get() = this@TestServerRequest.port ?: 80
        ...
        override val version: String
            get() = this@TestServerRequest.version
 ...
 */
public fun TestServerRequest.setBody(value: String) {
 ...
 */
public fun TestServerRequest.setBody(value: ByteArray) {
...
public fun TestServerRequest.setBody(value: Source) {
...
public fun TestServerRequest.setBody(boundary: String, parts: List<PartData>) {
