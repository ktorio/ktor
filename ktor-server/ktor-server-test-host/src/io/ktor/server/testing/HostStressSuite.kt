...
abstract class HostStressSuite<THost : ApplicationHost, TConfiguration : ApplicationHost.Configuration>(hostFactory: ApplicationHostFactory<THost, TConfiguration>) : HostTestBase<THost, TConfiguration>(hostFactory) {
    init {
        enableHttp2 = false
        enableSsl = false
    }
