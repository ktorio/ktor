...
internal class NettyHttp1ServerCall(
    server: Server,
...
) : NettyServerCall(server, context, httpRequest) {

    override val request = NettyHttp1ServerRequest(
        this,
        engineContext,
        context,
        httpRequest,
    ...
    override val response = NettyHttp1ServerResponse(
        this,
        context,
        engineContext,
        userContext,
