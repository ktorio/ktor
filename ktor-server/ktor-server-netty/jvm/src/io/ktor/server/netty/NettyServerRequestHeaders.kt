...
@Deprecated(message = "Renamed to NettyServerRequestHeaders", replaceWith = ReplaceWith("NettyServerRequestHeaders"))
public typealias NettyApplicationRequestHeaders = NettyServerRequestHeaders

public class NettyServerRequestHeaders(request: HttpRequest) : Headers {
