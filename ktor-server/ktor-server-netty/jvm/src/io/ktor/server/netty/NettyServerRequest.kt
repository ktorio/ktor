...
@Deprecated(message = "Renamed to NettyServerRequest", replaceWith = ReplaceWith("NettyServerRequest"))
public typealias NettyApplicationRequest = NettyServerRequest

public abstract class NettyServerRequest(
    call: PipelineCall,
...
) : BaseServerRequest(call), CoroutineScope {
    ...
    override val cookies: RequestCookies = NettyServerRequestCookies(this)
