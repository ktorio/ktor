...
@Deprecated(message = "Renamed to NettyServerResponse", replaceWith = ReplaceWith("NettyServerResponse"))
public typealias NettyApplicationResponse = NettyServerResponse

public abstract class NettyServerResponse(
