...
@Deprecated(message = "Renamed to NettyServerCall", replaceWith = ReplaceWith("NettyServerCall"))
public typealias NettyApplicationCall = NettyServerCall

public abstract class NettyServerCall(
    server: Server,
    public val context: ChannelHandlerContext,
    private val requestMessage: Any,
) : BaseServerCall(server) {

    public abstract override val request: NettyServerRequest
    public abstract override val response: NettyServerResponse
