...
internal class NettyHttp2ServerResponse(
    call: NettyServerCall,
    val handler: NettyHttp2Handler,
    context: ChannelHandlerContext,
    engineContext: CoroutineContext,
    userContext: CoroutineContext
) : NettyServerResponse(call, context, engineContext, userContext) {
    ...
    override fun push(builder: ResponsePushBuilder) {
        context.executor().execute {
            handler.startHttp2PushPromise(this@NettyHttp2ServerResponse.context, builder)
        }
    }
