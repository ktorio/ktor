...
internal class NettyHttp2ConnectionHandler(val encoder: Http2ConnectionEncoder, decoder: Http2ConnectionDecoder, settings: Http2Settings) : Http2ConnectionHandler(decoder, encoder, settings) {
