...
@Deprecated(message = "Renamed to TomcatServerEngine", replaceWith = ReplaceWith("TomcatServerEngine"))
public typealias TomcatApplicationEngine = TomcatServerEngine

/**
 * Tomcat application engine that runs it in embedded mode
 */
public class TomcatServerEngine(
    ...
    private val ktorServlet = object : KtorServlet() {
        ...
        override val enginePipeline: EnginePipeline
            get() = this@TomcatServerEngine.pipeline
        val server: Server
            get() = this@TomcatServerEngine.serverProvider()
        override val upgrade: ServletUpgrade
            get() = DefaultServletUpgrade
        override val logger: Logger
            get() = this@TomcatServerEngine.environment.log
    ...
    override fun start(wait: Boolean): TomcatServerEngine {
