...
/**
 * Session transformer that will encrypt/decrypt the input.
 *
 * Where the input is either a session contents or a previous transformation.
 *
 * It will encrypt/decrypt the input with an [encryptAlgorithm] and an [encryptionKeySpec]
 * and will include an authenticated MAC (Message Authentication Code) hash with [signAlgorithm] and a [signKeySpec]
 * and will include an IV (Initialization Vector) that is generated by an [ivGenerator] by default secure random bytes.
 *
