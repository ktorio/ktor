...
class MergedServerConfigTest {

    @Test
    fun testProperty() {
        val first = MapServerConfig("first" to "value1")
        val second = MapServerConfig("first" to "value2", "second" to "value3")
        val config = MergedServerConfig(first, second)
    ...
    @Test
    fun testConfig() {
        val first = MapServerConfig("first.second.third1" to "value1", "first.second.third2" to "value2")
        val second = MapServerConfig("first.second.third1" to "ignored", "first.second.third3" to "value3")
        val config = MergedServerConfig(first, second)
