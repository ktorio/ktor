 ...
 * By default, it fallbacks to [RequestProperties.local]
 */
@Suppress("DEPRECATION")
public val RequestProperties.origin: RequestConnectionPoint
 ...
 * By default, all the properties are equal to [RequestProperties.local] with [RequestConnectionPoint.serverHost]
...
internal class OriginConnectionPoint(
    ...
    constructor(call: CallProperties) : this(call.request.local, call.request.header(HttpHeaders.Host))
 ...
 */
@Suppress("DEPRECATION")
public val CallProperties.mutableOriginConnectionPoint: MutableOriginConnectionPoint
