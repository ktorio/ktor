 ...
 **/
public val ServerConfig.port: Int get() = propertyOrNull("ktor.deployment.port")?.getString()?.toInt() ?: 8080

/**
 * The host address of the currently running application, as defined by the configuration at start-up.
 **/
public val ServerConfig.host: String get() = propertyOrNull("ktor.deployment.host")?.getString() ?: "0.0.0.0"
