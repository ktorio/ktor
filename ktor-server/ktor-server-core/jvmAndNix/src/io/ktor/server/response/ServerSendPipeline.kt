...
@Deprecated(message = "Renamed to ServerSendPipeline", replaceWith = ReplaceWith("ServerSendPipeline"))
public typealias ApplicationSendPipeline = ServerSendPipeline

/**
 * Server response send pipeline.
 */
public open class ServerSendPipeline(
