...
@Deprecated(message = "Renamed to BaseServerResponse", replaceWith = ReplaceWith("BaseServerResponse"))
public typealias BaseApplicationResponse = BaseServerResponse
...
public abstract class BaseServerResponse(
    ...
    public final override val pipeline: ServerSendPipeline = ServerSendPipeline(
        call.server.developmentMode
    ).apply {
        resetFrom(call.server.sendPipeline)
    }
...
//            }
    ...
    public companion object {
         ...
         */
        public val EngineResponseAttributeKey: AttributeKey<BaseServerResponse> =
            AttributeKey("EngineResponse")

        /**
         * Install an application-wide send pipeline interceptor into [ServerSendPipeline.Engine] phase
         * to start response object processing via [respondOutgoingContent]
         */
        public fun setupSendPipeline(sendPipeline: ServerSendPipeline) {
            sendPipeline.intercept(ServerSendPipeline.Engine) { body ->
                ...
                val response = call.response as? BaseServerResponse
