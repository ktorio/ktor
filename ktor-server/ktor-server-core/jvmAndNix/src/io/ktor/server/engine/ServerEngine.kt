...
@Deprecated(message = "Renamed to ServerEngine", replaceWith = ReplaceWith("ServerEngine"))
public typealias ApplicationEngine = ServerEngine
...
public interface ServerEngine {
    ...
    /**
     * A configuration for the [ServerEngine].
     */
     ...
     */
    public fun start(wait: Boolean = false): ServerEngine

    /**
     * Stops this [ServerEngine].
     *
