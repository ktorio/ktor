...
public class WebResourcesConfig internal constructor() {
     ...
     * A path provided to a predicate is always slash-separated (`/`).
     *
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.server.servlet.WebResourcesConfig.excludes)
     */
     ...
     *
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.server.servlet.WebResourcesConfig.mimeResolve)
     */
     ...
     *
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.server.servlet.WebResourcesConfig.include)
     *
     * @see includes
     */
     ...
     *
     * [Report a problem](https://ktor.io/feedback/?fqname=io.ktor.server.servlet.WebResourcesConfig.exclude)
     *
     * @see excludes
     */
