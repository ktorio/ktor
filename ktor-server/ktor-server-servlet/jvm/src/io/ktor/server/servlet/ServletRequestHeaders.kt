...
@Deprecated(
    message = "Renamed to ServletServerRequestHeaders",
    replaceWith = ReplaceWith("ServletServerRequestHeaders")
)
public typealias ServletApplicationRequestHeaders = ServletRequestHeaders

public class ServletRequestHeaders(
