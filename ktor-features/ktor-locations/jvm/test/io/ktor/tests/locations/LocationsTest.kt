...
class LocationsTest {
    ...
    fun `location class with big numbers`() = withLocationsApplication {
        val bd = BigDecimal("123456789012345678901234567891")
        val bi = BigInteger("123456789012345678901234567892")
        ...
        urlShouldBeHandled(
            "/?bi=123456789012345678901234567892&bd=123456789012345678901234567891",
            "/?bi=123456789012345678901234567892&bd=123456789012345678901234567891"
        )
    }
