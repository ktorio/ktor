...
open class AuthenticationProvider(config: Configuration) {
    ...
    /**
     * Use failure response alternative [ForbiddenResponse] instead of [UnauthorizedResponse]
     */
    internal val useForbiddenResponse: Boolean = config.useForbiddenResponse
    ...
    open class Configuration protected constructor(val name: String?) {
        ...
        /**
         * Use alternative response to prevent the browser credential popup on a failure. This is useful only if you plan
         * to implement a custom login interface that does not require the popup generated by the browser.
         */
        var useForbiddenResponse: Boolean = false
