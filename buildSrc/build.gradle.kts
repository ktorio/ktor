...
plugins {
    ...
    kotlin("plugin.serialization") version "1.9.0-moon-100535"
}
...
dependencies {
    implementation(kotlin("gradle-plugin", "1.9.0-moon-100535"))
    implementation(kotlin("serialization", "1.9.0-moon-100535"))
