...
plugins {
    kotlin("plugin.serialization") version "2.0.20-dev-6052"
...
dependencies {
    implementation(kotlin("gradle-plugin", "2.0.20-dev-6052"))
    implementation(kotlin("serialization", "2.0.20-dev-6052"))
